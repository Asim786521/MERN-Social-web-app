    ...
    (async () => {
      try {
        const res = await axios.get(
          `http://localhost:4000/auth/getUser-Profile/${userId}`
        );
      ...
      <div className="container-fluid mt-3">
            ...
            <div class="avatar-upload">
              ...
              <div className="avatar-preview">
                <div
                  ...
                  style={{
                    backgroundImage: `url(http://localhost:4000/User/${profileImage})`,
                  }}
                ></div>
              </div>
            </div>
        ...
        <div className={`sidebar ${isOpen === true ? "active" : ""}`}>
          ...
          <div className="sd-body">
            <ul>
              <li>
                <a className="sd-link" href="/posts">
                  posts
                </a>
              </li>
              <li>
                <a className="sd-link" href="/chats">
                  chat
                </a>
              </li>
              <li>
